...
document.getElementById('button').onclick = function () {
    ...
    var tasksArray = document.getElementById('promises-wrapper').querySelectorAll('li');
    ...
    tasksArray.forEach(function (task) {
        ...
        promise = promise.then(function () {
            return new Promise(function (success, error) {
                // console.log(promise);
                var randomTimeout = Math.floor(Math.random() * 2000);
...
// 		            }
// 		            else {
// 			            var error = new Error(statusObject.statusText);
// 			            error.code = statusObject.status;
// 			            reject(error);
//
// 		            };
